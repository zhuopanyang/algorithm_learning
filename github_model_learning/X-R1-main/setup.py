...
stale_egg_info = Path(__file__).parent / "x_r1.egg-info"
if stale_egg_info.exists():
    print(
        (
            "Warning: {} exists.\n\n"
            "If you recently updated x_r1, this is expected,\n"
            "but it may prevent x_r1 from installing in editable mode.\n\n"
...
setup(
    ...
    author="dhcode-cpp",
    author_email="dhcode95@gmail.com",
    description="X-R1",
    long_description=open("README.md", "r", encoding="utf-8").read(),
    long_description_content_type="text/markdown",
    keywords="reasoning llm RL-Zero training",
    license="Apache",
